...
Per mantenere in ordine e facilmente accessibili i diversi file collegati a una medesima analisi è possibile creare un progetto di RStudio. Durante il corso lavoreremo all'interno di un progetto dedicato: creiamolo cliccando sull'icona ![](images/rproject.png){height=25} di Rstudio, in alto a destra.
Scegliamo "New Project..." e dopo aver selezionato "New directory" decidiamo dove salvare il progetto e con quale nome.

All'interno della cartella dedicata al progetto creiamo la cartella `data` e salviamo al suo interno un [dataset in formato xlsx](https://github.com/ARPAL-liguria-it/2025_R_corso/raw/refs/heads/main/data/2025-04-24_anagrafica_stazioni.xlsx) e [uno in formato csv compresso](https://github.com/ARPAL-liguria-it/2025_R_corso/raw/refs/heads/main/data/2025-04-24_pm1025_ambiente_liguria.csv.gz): li utilizzeremo nel @sec-datatable.
...
- `quarto`: utilizzeremo la funzione `quarto_render()` per produrre report in serie;
