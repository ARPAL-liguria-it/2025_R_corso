...
Al termine del corso, sarà proposto lo sviluppo di una breve applicazione dei concetti e delle tecniche imparate, con lo scopo di creare un documento completo e autonomo che possa facilitare un aspetto del proprio contesto lavorativo.
...
Per mantenere in ordine e facilmente accessibili i diversi file collegati a una medesima analisi è possibile creare un progetto di RStudio. Durante il corso si lavorerà all'interno di un progetto dedicato: per crearlo è necessario cliccare sull'icona ![](images/rproject.png){height=25} di Rstudio, in alto a destra.
Selezionando prima "New Project..." e poi "New directory" è richiesto dove salvare il progetto e con quale nome.
...
Quando necessario, si procederà direttamente a caricare e usare tali pacchetti.
