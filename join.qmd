...
In questo capitolo imparerai a integrare informazioni da tabelle diverse combinando due dataset con colonne chiave comuni. Vedrai come utilizzare diverse tipologie di **join** con il pacchetto `data.table`, gestendo casi di chiavi mancanti o non corrispondenti.
