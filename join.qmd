...
Se si vogliono mantenere solo i campioni per cui sono disponibili sia le misure che l'indirizzo, si usa un **inner join**. In termini di insiemi, corrisponde alliintersezione $A \cap B$, come mostrato in @fig-inner.
